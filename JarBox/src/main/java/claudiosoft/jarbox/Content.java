...
public class Content {
    ...
    public Content() throws JarBoxException {
        try {
            ...
            throw new JarBoxException(ex.getMessage(), ex);
        }
    }
    ...
    public final ContentEntry getEntry(String entryFullName) throws JarBoxException {
        for (ContentEntry entry : contentEntries) {
            if (entry.getFullName().equals(entryFullName)) {
                return entry;
            }
        }
        throw new JarBoxException("no entry found with full name " + entryFullName);
    }
